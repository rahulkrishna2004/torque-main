  ...
  return (
    <footer className="bg-black text-white py-16 px-4 sm:px-10 lg:px-20 w-full">
      <motion.div
        ...
        className="border-b border-gray-700 mb-8 pb-4"
      />

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 text-center lg:text-left max-w-7xl mx-auto">
        {/* 1. Quick Links */}
        <motion.div
      ...
      <motion.div
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, delay: 0.8 }}
        className="border-t border-gray-700 mt-10 pt-4 flex flex-col sm:flex-row justify-center sm:justify-between items-center text-sm text-gray-400 max-w-7xl mx-auto"
      >
