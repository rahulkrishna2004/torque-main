    ...
    <div className="min-h-screen w-full bg-black py-12 px-4 sm:px-6 lg:px-8">
      <motion.div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-white bebas font-bold text-4xl sm:text-5xl lg:text-4xl text-center leading-tight sm:leading-[66px] mb-8 sm:mb-12">
          Slide & See What{" "}
          <span className="text-[#00d9ff] font-bold ">We Can Do</span>
        </h1>
        ...
        >
          <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-6 sm:gap-8 lg:gap-12 items-center sm:items-stretch">
            {features.map((item, index) => (
              ...
              >
                ...
                <p className="font-semibold mt-3 text-white text-xs sm:text-base">
                  {item.text}
                </p>
              </motion.div>
            ))}
